...
func TestRelayersShouldExecuteSimpleTransfersFromKleverchainToEth(t *testing.T) {
	...
	kleverchainChainMock := mock.NewKleverChainMock()
	...
	pendingBatch := mock.KleverchainPendingBatch{
		Nonce:               big.NewInt(1),
		KleverchainDeposits: deposits,
	}
...
func createTransactions(n int) ([]mock.KleverchainDeposit, []common.Address, map[common.Address]*big.Int) {
	tokensAddresses := make([]common.Address, 0, n)
	deposits := make([]mock.KleverchainDeposit, 0, n)
...
func createTransaction(index int) (mock.KleverchainDeposit, common.Address) {
	tokenAddress := testsCommon.CreateRandomEthereumAddress()

	return mock.KleverchainDeposit{
...
func checkTestStatus(
	t *testing.T,
	kleverchainChainMock *mock.KleverChainMock,
	ethereumChainMock *mock.EthereumChainMock,
	numTransactions int,
	deposits []mock.KleverchainDeposit,
