...
func TestExecute_GetPending(t *testing.T) {
	...
	t.Run("error on GetBatchFromKc", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("error on StoreBatchFromKc", func(t *testing.T) {
		t.Parallel()
		bridgeStub := createStubExecutorGetPending()
	...
	t.Run("should work", func(t *testing.T) {
		t.Parallel()
		t.Run("if transfer already performed next step should be ResolvingSetStatusOnKc", func(t *testing.T) {
			t.Parallel()
			bridgeStub := createStubExecutorGetPending()
			bridgeStub.WasTransferPerformedOnEthereumCalled = func(ctx context.Context) (bool, error) {
				return true, nil
			...
			expectedStepIdentifier := bridgeCore.StepIdentifier(ResolvingSetStatusOnKc)
			stepIdentifier := step.Execute(context.Background())
			assert.Equal(t, expectedStepIdentifier, stepIdentifier)
